...
public class LeavedEmployees extends JFrame {
    private DefaultTableModel model;
    private JTable table;
    private JTextField searchField;

    public LeavedEmployees(JFrame parent) {
        setTitle("Leaved Employees");
        setSize(1000, 600);
        ...
        JLabel heading = new JLabel("Employees Who Have Left");
    ...
    private void loadData() {
        model.setRowCount(0);
        String query = "SELECT * FROM employees WHERE status = 'Leaved'";
    ...
    private void search() {
        ...
        model.setRowCount(0);
        String query = "SELECT * FROM employees WHERE status = 'Leaved' AND (employee_id LIKE ? OR name LIKE ?)";
        try (Connection con = DBConnection.getConnection();
             PreparedStatement stmt = con.prepareStatement(query)) {
